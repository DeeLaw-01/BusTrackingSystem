...
export default function AuthLayout() {
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen flex items-center justify-center" style={{ backgroundColor: '#8b5544' }}>
  ...
  return (
    <div className="min-h-screen auth-bg-pattern flex flex-col" style={{ backgroundColor: '#8b5544' }}>
