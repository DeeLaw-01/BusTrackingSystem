    ...
    return (
      <div className="flex flex-col items-center justify-center h-screen bg-slate-50 px-4 text-center">
        <div className="w-14 h-14 rounded-full bg-gray-100 flex items-center justify-center mb-4">
          <AlertCircle className="w-7 h-7 text-gray-1000" />
        </div>
  ...
  return (
    <div className="h-screen flex flex-col overflow-hidden bg-white">
      ...
      {tripActive && nextStop ? (
        /* Navigation header */
        <div
          className="h-16 flex items-center gap-3 px-4 shrink-0 z-20"
          style={{
            background: "#ffffff",
        ...
        /* Pre-trip header */
        <div className="h-16 bg-white border-b border-slate-200 flex items-center justify-between px-4 shrink-0 z-20">
          <div>
      ...
      <div className="flex-1 relative overflow-hidden">
        {/* Inline error/location alerts */}
        {error && (
          <div className="absolute top-3 left-3 right-3 z-1000 alert alert-error text-sm">
            {error}
          </div>
        )}
        {locationError && tripActive && (
          <div className="absolute top-3 left-3 right-3 z-1000 alert alert-warning text-sm">
        ...
        {tripActive && (
          <button
            ...
            className={`absolute bottom-28 right-4 z-1000 p-3 rounded-full shadow-lg transition-all ${
              followMode
        ...
        {tripActive && (
          <div className="absolute bottom-0 left-0 right-0 z-1000">
            <div className="bg-white border-t border-slate-200 shadow-[0_-4px_20px_rgba(0,0,0,0.08)] px-4 py-3">
              ...
              <div className="flex gap-2 overflow-x-auto pb-1 scrollbar-hide">
                {stops.slice(nextStopIdx).map((stop, i) => (
                  <div
                    key={stop._id}
                    className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg shrink-0 text-sm ${
                      i === 0
                  ...
                  >
                    <MapPin
                      className={`w-3.5 h-3.5 shrink-0 ${i === 0 ? "text-gray-1000" : "text-slate-400"}`}
                    />
